...
public class FileDocument {
  /** Makes a document for a File.
    ...
    Reader field;
    */
	public static Document indexDocWithURL(String content,String triples, String url)throws java.io.FileNotFoundException {

		   Document doc = new Document();
//		   String subject = "";
////		   System.out.println(url+"\n"+content+"\n");
//		   if(content.contains("Halong"))
//			   System.out.println(content);
		   ...
		   doc.add(new Field("triples", triples, Field.Store.YES, Field.Index.NOT_ANALYZED,TermVector.WITH_POSITIONS_OFFSETS));
