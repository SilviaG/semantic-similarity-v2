...
//	static String id = "76";
//	public static String outputfile = "0"+id+"nb.txt";
...
//	public static String indexfile = "../im@oaei2012-000-080/004/basicFeatureIndex-new";
	...
	public static String outputfile = "OntologyMatchingTest/ontomyresult/conference-ekaw.rdf";//"loc100semsim.rdf";//"nyt-dbpedia-people-100-result.rdf";//"/Users/zhengj3/Downloads/OAEI2012InstanceMatchingIIMBResult/062/semsim.rdf";//"../im@oaei2012-000-080/062/semsim.rdf";
	public static String standardfile = "OntologyMatchingTest/refalign/conference-ekaw.rdf";//"nyt-dbpedia-people-mappings.rdf";
	public static String indexfile = "nyt-dbpedia-people-100-basicFeatureIndex";
...
//						String output = "cmt-cmt-cn-cz.rdf";		
						standardfile = "OntologyMatchingTest/Library/refalign/referenceSKOS.rdf";//
						outputfile = "OntologyMatchingTest/Library/libIndex.rdf";					

//						String output = o1+"-"+o2+".rdf";	
//						standardfile = "OntologyMatchingTest/refalign/"+output;//
//						outputfile = "OntologyMatchingTest/ontomyresultEntropy/"+output;	
//						
//						standardfile = "nyt-dbpedia-locations-mappings.rdf";
//						outputfile = "filteredlocations.rdf";
						
//						standardfile = "NYTDBpediaResult/refalign/nyt-dbpedia-organizations-mappings.rdf";//+output;
//						outputfile = "NYTDBpediaResult/myresult/filteredorganization.rdf";//+output;
			count++;
...
//            entity2 = entity2.replaceAll("\\(", "%28").replaceAll("\\)", "%29").replaceAll(",", "%2C").replaceAll("'", "%27");
	...
	public static double compare(String filename,String reffile,String index) {
        ...
        while ((triple = br.readLine()) != null )   {
        	...
        	if(triple.contains("measure"))
        		score = Double.parseDouble(triple.substring(triple.indexOf(">")+1,triple.lastIndexOf("<")));
//        	System.out.println(triple);            
//        	System.out.println("e1: "+entity1);
//        	System.out.println("e2: "+entity2);

            if(entity1.equals("")||entity2.equals("")||score<0.00)
            	continue;
